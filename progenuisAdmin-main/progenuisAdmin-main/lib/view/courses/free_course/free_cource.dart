...
class FreeCourseScreen extends StatelessWidget {
  final FreeCourseController courseController = Get.put(FreeCourseController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Free Content', style: TextStyle(color: Colors.white)),
        ...
        actions: [
          IconButton(
            onPressed: () => showAddCourseDialog(context,courseController),
...
void showAddCourseDialog(BuildContext context, FreeCourseController courseController) {
            ...
            Obx(() => courseController.isLoading.value
                ...
                : CustomButton(
                    ...
                    onPressed: () async {
                      ...
                      // Start loading
                      await courseController.addCourse(newCourse, selectedImage.value!, "UNPAID");
