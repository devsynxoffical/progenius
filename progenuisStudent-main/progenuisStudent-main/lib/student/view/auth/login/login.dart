...
import 'package:progenius/student/view/auth/forget_password/email_screen.dart';
import 'package:progenius/student/view/auth/signUp/signUp.dart';
                ...
                child: Column(
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Text.rich(
                        TextSpan(
                          text: AllTexts.donthaveAccount,
                          style: TextStyle(color: Colors.grey, fontSize: 14),
                          children: [
                            TextSpan(
                              text: AllTexts.createNew,
                              style: TextStyle(
                                  color: Colors.purple,
